...
class FriendGroup {
  ...
  FriendGroup copyWith({String? name, String? emoji, List<String>? usernames}) =>
      FriendGroup(
        id: id,
        name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() =>
      {'id': id, 'name': name, 'emoji': emoji, 'usernames': usernames};
...
class FriendGroupStore {
  ...
  static Future<FriendGroup> create(String name,
      {String emoji = '👥', List<String> usernames = const []}) async {
    final g = FriendGroup(
        id: const Uuid().v4(),
        name: name.trim(),
        emoji: emoji,
